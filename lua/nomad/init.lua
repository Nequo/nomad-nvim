...
vim.g["colors_name"] = "nomad"
vim.o["termguicolors"] = true

local p = require("nomad.colors")
...
hl(0, "FoldColumn", { fg = c.base02, bg = c.base01 })
...
hl(0, "DiagnosticInfo", { fg = c.pink, bg = c.none })
...
hl(0, "Constant", { fg = c.alien, bg = c.none })
...
hl(0, "Number", { fg = c.alien, bg = c.none })
hl(0, "Float", { link = "Number" })
hl(0, "Operator", { fg = c.pink, bg = c.none })
...
hl(0, "@lsp.type.macro.rust", { fg = c.yellow, bg = c.none })
...
hl(0, "TelescopePreviewTitle", { fg = c.base04, bg = c.none })
hl(0, "TelescopePromptTitle", { fg = c.base04, bg = c.none })
hl(0, "TelescopeResultsTitle", { fg = c.base04, bg = c.none })
...
-- mini.nvim
hl(0, "MiniIconsAzure", { bg = c.none, fg = c.alien, bold = false })
hl(0, "MiniIconsBlue", { bg = c.none, fg = c.blue, bold = false })
hl(0, "MiniIconsCyan", { bg = c.none, fg = c.alien, bold = false })
hl(0, "MiniIconsGreen", { bg = c.none, fg = c.green, bold = false })
hl(0, "MiniIconsGrey", { bg = c.none, fg = c.grey, bold = false })
hl(0, "MiniIconsOrange", { bg = c.none, fg = c.orange, bold = false })
